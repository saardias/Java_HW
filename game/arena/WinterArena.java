 ...
 * representation of a Winter arena
 */
public class WinterArena implements IArena {
     ...
     */
    public WinterArena(double length, SnowSurface surface, WeatherCondition condition) throws IllegalArgumentException{
    ...
    /**
     * @param surface the the Snow Surface of arena
     */
    @Override
